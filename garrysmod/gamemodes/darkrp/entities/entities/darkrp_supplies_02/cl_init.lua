...
function ENT:DrawCustom3D2D()
	...
	cam.Start3D2D(pos, ang, 0.15)
		...
		if capturestatus < 1 then
			draw.SimpleText("Бандиты могут их захватить", "font_24s", 0, 30, c000, 1, 1)
			draw.SimpleText("Бандиты могут их захватить", "font_24r", 0, 30, c255255255, 1, 1)
		else
			status = Lerp(FrameTime() * 6, status, capturestatus)

			draw.RoundedBox(0, -80, 30, 160, 5, c1657343)
			draw.RoundedBox(0, -80, 30, 160 * (status / 18), 5, c25510251)
		end
	cam.End3D2D()

...
function ENT:Use(ply)
	...
	-- limit
	if ply:GetCount("retrime.FactoryWater") > 2 then
		notify(ply, 0, 4, "Вы достигли лимита раздатчика воды")
		return
	end
	...
	-- ent
	local ent = ents.Create("darkrp_factory_05")
	...
	ply:AddCount("retrime.FactoryWater", ent)

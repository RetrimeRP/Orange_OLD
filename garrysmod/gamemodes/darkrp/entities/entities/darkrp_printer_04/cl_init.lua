...
local c10358183 = Color(103, 58, 183)
local c150150150 = Color(150, 150, 150)
local c5732100 = Color(57, 32, 100)
...
function ENT:Draw()
	...
	cam.Start3D2D(pos, ang, 0.075)
		draw.SimpleText("Редкий принтер", "font_32b", 0, -2, c10358183, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
	...
	cam.Start3D2D(pos2, ang2, 0.05)
		draw.SimpleText(DarkRP.formatMoney(printed), "font_48b", -110, 60, c10358183, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
		draw.SimpleText(DarkRP.formatMoney(print) .. "/мин", "font_22r", -110, 60, c150150150, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
		draw.RoundedBox(0, 19, 25, 142, 26, c5732100)
		draw.RoundedBox(0, 19, 25, progress, 26, c10358183)

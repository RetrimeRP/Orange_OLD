...
function ENT:Use(ply)
	...
	-- limit
	if ply:GetCount("retrime.FactoryRation") > 2 then
		notify(ply, 0, 4, "Вы достигли лимита раздатчика рационов")
		return
	end
	...
	-- ent
	local ent = ents.Create("darkrp_factory_06")
	...
	ply:AddCount("retrime.FactoryRation", ent)

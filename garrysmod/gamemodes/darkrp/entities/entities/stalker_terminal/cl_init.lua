...
function ENT:Draw()
	...
	if LocalPlayer():Team() != TEAM_SYNTH2 then return end
	...
	cam_Start3D2D(pos + vec + ang:Right() * 1.2, ang, 0.25)
		draw_SimpleTextOutlined('Требуется ремонт', 'ui.30', 0, 0, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, 1, color_black)
	cam_End3D2D()

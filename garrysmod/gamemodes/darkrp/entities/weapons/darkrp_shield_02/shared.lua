...
do
	...
	util.PrecacheModel("models/cloud/ballisticshield_mod.mdl")
...
if SERVER then
	...
	function SWEP:CreateShield()
		...
		self.Shield:SetModel("models/cloud/ballisticshield_mod.mdl")
		...
		self.Shield:SetLocalAngles(Angle(-70, 250, 20))
		self.Shield:SetLocalPos(Vector(-1, -42, -33))
		self.Shield:Spawn()
	end

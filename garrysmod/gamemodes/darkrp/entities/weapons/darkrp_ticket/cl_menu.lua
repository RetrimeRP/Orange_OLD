...
local ticket_combine = Material("materials/retrime_orange/combine.png")
local ticket_close = Material("materials/retrime_orange/close.png")

net.Receive("OpenTicketMenu", function()
	...
	pnl.Paint = function(self, w, h)
		...
		draw.SimpleText("Миграционный билет", "font_22r", 17, 20, c303030, 0, 1)
		draw.Icon(w - 256, h - 180, 256, 256, c424242, ticket_combine)
	end
	...
	pnl.cls.Paint = function(self, w, h)
		draw.Icon(0, 0, w, h, c303030, ticket_close)
	end
	...
	pnl.pnl1.Paint = function(self, w, h)
		draw.SimpleText("ГРАЖДАНИН", "font_22r", 23, 7, c109109109)
		draw.SimpleText("ПРИБЫТИЕ В", "font_22r", 23, 41, c109109109)
		draw.SimpleText("ОТБЫТИЕ ИЗ", "font_22r", 23, 75, c109109109)
		draw.SimpleText("ПРИЧИНА", "font_22r", 23, 109, c109109109)
	end
	...
	pnl.pnl2.Paint = function(self, w, h)
		...
		draw.SimpleText("Сити 82", "font_22r", 9, 41, c255255255)
		draw.RoundedBox(0, 10, 96, w - 10, 1, c25525525525)
		draw.SimpleText(city, "font_22r", 9, 75, c255255255)
		draw.RoundedBox(0, 10, 130, w - 10, 1, c25525525525)
		draw.SimpleText(reason, "font_22r", 9, 109, c255255255)
	end

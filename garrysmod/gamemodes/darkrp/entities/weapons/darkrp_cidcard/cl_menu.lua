...
net.Receive("OpenCIDCard", function()
	...
	pnl.Paint = function(self, w, h)
		...
		draw.SimpleText("CID карта", "font_22r", 17, 20, c303030, 0, 1)
	...
	pnl.pnl1.Paint = function(self, w, h)
		...
		draw.SimpleText("ГОРОД", "font_22r", 23, 41, c109109109)
		draw.SimpleText("CID НОМЕР", "font_22r", 23, 75, c109109109)
	end
	...
	pnl.pnl2.Paint = function(self, w, h)
		...
		draw.SimpleText(cid, "font_22r", 9, 75, c255255255)
	end

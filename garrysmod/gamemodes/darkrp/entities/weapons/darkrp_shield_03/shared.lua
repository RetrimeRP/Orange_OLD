...
do
	...
	util.PrecacheModel("models/c_sh/c_sh.mdl")
...
if SERVER then
	...
	function SWEP:CreateShield()
		...
		self.Shield:SetModel("models/c_sh/c_sh.mdl")
		...
		self.Shield:SetLocalAngles(Angle(70, 90, 0))
		self.Shield:SetLocalPos(Vector(0, 0, -21))
		self.Shield:Spawn()
	end

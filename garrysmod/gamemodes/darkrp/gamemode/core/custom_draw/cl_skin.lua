...
SKIN.PrintName = "Sunraice"
SKIN.DermaVersion = 1
SKIN.GwenTexture = Material("gwenskin/retrime_orange.png")
...
SKIN.control_color_dark = Color(255, 255, 255, 255)

SKIN.bg_alt1 = Color(255, 255, 255, 255)
SKIN.bg_alt2 = Color(255, 255, 255, 255)

SKIN.listview_hover = Color(255, 255, 255, 255)
SKIN.listview_selected = Color(100, 170, 220, 255)

SKIN.text_bright = Color(255, 255, 255, 255)
SKIN.text_normal = Color(180, 180, 180, 255)
SKIN.text_dark = Color(215, 215, 215, 255)
...
SKIN.colTextEntryBG = Color(140, 140, 140, 255)
SKIN.colTextEntryBorder = Color(20, 20, 20, 255)
SKIN.colTextEntryText = Color(215, 215, 215, 255)
SKIN.colTextEntryTextHighlight = Color(140, 140, 140, 255)
SKIN.colTextEntryTextCursor = Color(215, 215, 215, 255)
SKIN.colTextEntryTextPlaceholder = Color(140, 140, 140, 255)

SKIN.colMenuBG = Color(255, 255, 255, 200)
SKIN.colMenuBorder = Color(255, 255, 0, 200)

SKIN.colButtonText = Color(255, 255, 255, 255)
SKIN.colButtonTextDisabled = Color(255, 255, 255, 55)
SKIN.colButtonBorder = Color(255, 255, 255, 255)
SKIN.colButtonBorderHighlight = Color(255, 255, 255, 50)
SKIN.colButtonBorderShadow = Color(255, 255, 255, 100)
...
derma.DefineSkin("retrime_orange", "Retrime Orange Skin", SKIN)

hook.Add("ForceDermaSkin", "DermaSkin", function()

	return "retrime_orange"

...
local male = {
	...
	"Мы думали вы пришли помочь",
	"Нам нужно пройти незамеченными",
	"Не говори так громко",
	"Ого дежавю",
	"Поговорим об этом позже",
	"Подумай лучше о работе",
	...
	"Туда",
	"Ты пошлейший тип",
	"Убирайтесь от сюда к чёрту",
	"Уходи от сюда",
	"Штурмовик",
	"Это больше чем мне нужно знать",
	"Это на тебя похоже",
	"Этот мотив так и засел у меня голове",
...
local female = {
	...
	"Мы думали вы пришли помочь",
	"Не говори так громко",
	"Не могу избавиться от этого мотива",
	"Ого дежавю",
	"Они будут искать тебя",
	"Они явно направляются сюда",
...
local mpf = {
	...
	["Сообщения"] = {
		...
		"Так точно",
		"Порядок, можешь идти",
		"Прикройте меня, я отхожу",
		"Гражданин",
		"Прикройте меня, я захожу",
		"Приговор приведён в исполнение",
		"Последнее предупреждение",
		"Первое предупреждение",
		"Есть один сообщник",
		"Здесь подозреваемый 1",
		"Граната",
		"Он убегает",
		"Вот он",
		"Я сказал отойти",
		"Есть попадание",
		"Отряд ГО, доложите статус",
		"Ищешь неприятностей?",
		"Помощь нужна?",
		"Офицеру нужна помощь",
		"Офицер под огнём, ухожу в укрытие",
		"Возможно нарушитель порядка 3 уровня",
		"Здесь нарушитель 2",
		"Преступление пресечено",
		"Отряд на месте, докладываю",
		"Поиск подозреваемых, без изменений",
		"Второе предупреждение",
		"Чёрт",
		"Перестрелка, нарушитель с оружием",
		"Угроза обществу",
		"Объект",
		"Объект тяжело ранен",
		"В зоне объектов нет",
	...
	["Статус"] = {
		...
		"Продолжаю поиск",
		"На позиции",
		"Приближаюсь к подозреваемому",
		"Убит",
		"Готов",
		"Выдвигаюсь",
		"Готов начинать",
		"Выдаю предписание о неповиновении",
		"Местонахождение",
		"Выхожу из боя",
		...
		"К бою готов",
		"Вас понял",
		"Боезапас на исходе, иду в укрытие",
		"Продолжаю поиск",
		"Иду в укрытие"
	},
	["Приказы"] = {
...
local ota = {
	...
	"Готов",
	"Держать позицию",
	"Доложите о наличии опасности",
	"Есть",
	"Есть контакт",
	"Есть попадание",
	"Команды стабилизации контролируют сектор",
	"Команды стабилизации на позициях",
	"Контакт",
	"Ложись ложись",
	"Нейтрализован",
	"Оружия к бою",
	"Оружия к бою, возможно опасность",
	"Понял",
	"Приближаюсь",
	"Прикрой",
	"Продолжаю зачистку",
	...
	"Цель пропала, прочесать местность",
	"Чисто"
}
...
local hecu = {
	...
	"Go, go, go",
	"Holy shit!",
	"I feel like we need more guys here",
	"Is that all you got?",
...
local vortigaunt = {
	...
	"Галалунг",
	"Галанга",
	"Забудем о Чёрной Мезе... на время",
	"За великую цель",
	"Иди за нами",
	...
	"Мы рады сопровождать",
	"Наше место здесь!",
	"Наш лучший поэт описывает это так",
	"Нельзя ли переубедить тебя?",
	"Позволь мне",
	"Пока это всё",
	"Прибыли",
	"Согласен",
	...
	"Ча галинг ча лалагунг",
	"Ча лан гон ча ла гур",
	"Чем тебе помочь?",
...
local negr = {
	"And now we wait",
	"Are you enjoing the games",
	"Begin the next game",
	"Bring'em to me alive",

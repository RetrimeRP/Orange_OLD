...
if file.Exists("darkrp_config/disabled_defaults.lua", "LUA") then
	...
	if SERVER then
		AddCSLuaFile("darkrp_config/disabled_defaults.lua")
	end
...
if SERVER and file.Exists("darkrp_config/mysql.lua", "LUA") then

	doInclude("darkrp_config/mysql.lua")
...
local customFiles = {
	...
	"darkrp_customthings/agendas.lua",
	"darkrp_customthings/doorgroups.lua",
	"darkrp_customthings/demotegroups.lua"

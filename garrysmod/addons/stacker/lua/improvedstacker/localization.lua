...
-- Tool Settings
localify.Bind( "en", prefix.."name",                     "Stacker" )
...
-- Tool Settings
localify.Bind( "bg", prefix.."name",                     "Натрупвач" )
...
localify.Bind( "fr", prefix.."name",                     "Stacker" )
...
-- Tool Settings
localify.Bind( "pl", prefix.."name",                     "Stacker" )
...
-- Tool Settings
localify.Bind( "ru", prefix.."name",                     "Stacker" )
...
-- Tool Settings
localify.Bind( "zh-cn", prefix.."name",                     "叠加器" )

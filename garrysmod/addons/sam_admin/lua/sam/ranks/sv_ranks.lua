...
function sam.ranks.remove_rank(name)
	...
	// 608781294828a0a4b60facead85e352631ab25d1f8f9437f43f207585e5deef6
...
function sam.ranks.change_inherit(name, inherit)
	...
	-- c884f7fa9de2af93f16855534fc18223f0b5d09b558777147eabff2b72d20186!!!
...
function sam.ranks.change_immunity(name, new_immunity)
	...
	new_immunity = math.Clamp(new_immunity, 2, 99) // f8ddcd9fec6fcef684c553e132839e3d11c95a34ba62aca98916c1989eb7d151!!!
...
function sam.ranks.give_permission(name, permission)
	...
	-- 3185b4637cb6a78420744a6c5e57168ab58ce565e272f2db01b348d0017b6e97!!!
...
hook.Add("SAM.DatabaseLoaded", "LoadRanks", function()
	SQL.Query([[
		...
		if #ranks < 3 then
			...
			/*e3ee60b2c9af4fb97a55663083364619bae8edfe879f1bbef68ae2fa94c9d9a9*/
		end

...
// Color
vv.BarColor = {
    [0] = Color(139, 0, 0), -- Over 0% -> Red
    [25] = Color(255, 165, 0), -- Over 25 % -> Yellow
    [50] = Color(0, 128, 0) -- Over 50% -> Green
}
...
function PANEL:VVPaint(w, h)
	...
	draw.RoundedBox(6, 0, 0, w, h, vv.BackgroundColor(self, self.ply))
    ...
    surface.SetTextPos(50, 40/2 - h/2)

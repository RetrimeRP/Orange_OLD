...
function ELEMENT:Init()
	...
	self.btn_text = ''
	self.btn_font = 'ui.20'
	self.standart_color = col.bg --ui.col.button()
	self.color = self.standart_color
	self.active_hover_color = true
	self.hover_color = col.basec --ui.col.header()
end
...
--	draw.RoundedBoxEx(10, 0, 0, w, h, col.outline, self.corner1_rounded, self.corner2_rounded, self.corner3_rounded, self.corner4_rounded)
	draw.RoundedBoxEx(26, 1, 1, w - 2, h - 2, self.color, self.corner1_rounded, self.corner2_rounded, self.corner3_rounded, self.corner4_rounded)
end
...
vgui.Register('ui-button', ELEMENT, 'DButton')

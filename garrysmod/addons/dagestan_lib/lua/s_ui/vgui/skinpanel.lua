...
function ELEMENT:Init()
	...
	self.Background.Paint = function(slf, w, h)
		ui.Blur(slf)
		draw.RoundedBox(0, 0, 0, w, h, ui.col.background())
	...
	self.Header.Paint = function(_, w, h)
		draw.RoundedBoxEx(6, 0, 0, w, h, ui.col.header(), true, true)
	...
	self.Title.Paint = function(_, w, h)
		--draw.SimpleText(self.title, 'ui.25',self:GetWide() * 0.02 + ui.w(55), h * 0.5 - 2, color_header_el, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER) --  self:GetWide() * 0.2
		draw.SimpleText(self.title, 'ui.26', self:GetWide() * 0.5, h * 0.5 - 2, color_header_el, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
...
vgui.Register('ui-frame2', ELEMENT, 'EditablePanel')

...
GAS:hook("PlayerDisconnected", "jobwhitelist:ClearPlayerAccessDataCache", function(ply)
    if GAS.JobWhitelist.Whitelists[GAS.JobWhitelist.LIST_TYPE_STEAMID][ply:AccountID()] then
    ...
    if GAS.JobWhitelist.Blacklists[GAS.JobWhitelist.LIST_TYPE_STEAMID][ply:AccountID()] then

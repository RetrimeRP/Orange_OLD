...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.M82.FIRE") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.IronAccuracy = .001*0.1 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 853/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/m82.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_m82_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(7.5, -8.5, 0.3)
...
SWEP.IronSightsPos = Vector(-3.7515, -3, 2.213)
...
SWEP.ScopeReticule = ("models/flaymi/stalker/anomaly/weapons/m82/wpn_crosshair_m82")

...
SWEP.PrintName				= "G3 SG1"		-- Weapon name (Shown on HUD)
...
--Firing Cone Related
SWEP.Primary.Spread = .026 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*2.6 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 820/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/g3sg1.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_g3sg1_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(5.5, -8.5, -0.2)
SWEP.RunSightsAng = Vector(-10, 51, -9)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.842, -4, 0.212)
...
SWEP.VElements = {
	["anomaly_sil_nato"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_scar_sight/wpn_sil_nato.mdl", bone = "wpn_body", rel = "", pos = Vector(0, -2, -13), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_nato"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_scar_sight/w_wpn_sil_nato.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 2.5, -6), angle = Angle(-93.5, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}
...
SWEP.ScopeReticule = ("models/flaymi/stalker/anomaly/weapons/g3sg1/wpn_crosshair_g3sg1")

SWEP.RTMaterialOverride = -1 --the number of the texture, which you subtract from GetAttachment

SWEP.RTOpaque = false

SWEP.Secondary.ScopeZoom = 4 --IMPORTANT BIT

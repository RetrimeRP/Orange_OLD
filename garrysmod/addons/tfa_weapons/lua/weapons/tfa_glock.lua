...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.GLOCK.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.GLOCK.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.IronAccuracy = .001*3.4 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/glock.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_glock_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -3, 3.6)
...
SWEP.IronSightsPos = Vector(-4.545, -2, 2.562)
...
SWEP.VElements = {
	["anomaly_sil_gemtech"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sil_gemtech/addon_sil_gemtech.mdl", bone = "wpn_body", rel = "", pos = Vector(0.045, -0.06, 0.1), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_gemtech"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sil_gemtech/addon_sil_gemtech_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0.06, 5.56, 0.4), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_gemtech" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_glock_sk1", "anomaly_glock_sk2" }, order = 5 },

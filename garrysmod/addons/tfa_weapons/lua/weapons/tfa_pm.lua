...
SWEP.Category				= "Retrime [Пистолет]" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.CZ52.FIRE") -- This is the sound of the weapon, when you shoot. -- TFA_ANOMALY.PM.FIRE
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.CZ52.FIRE_SILENCED") -- This is the sound of the weapon, when silenced. -- TFA_ANOMALY.PM.FIRE_SILENCED
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 22.5 -- Damage, in standard damage points.
...
SWEP.Primary.RPM = 315 -- This is in Rounds Per Minute / RPM
...
--Firing Cone Related
SWEP.Primary.Spread = .062 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*6.2 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 290/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
SWEP.MaxPenetrationCounter = 2 --The maximum number of ricochets.  To prevent stack overflows.
--Misc
SWEP.IronRecoilMultiplier = 0.625 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/cstrike/c_pist_fiveseven.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_pist_fiveseven.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -1, 3.8)
SWEP.RunSightsAng = Vector(-19, 3, -6)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.83, -1, 2.1115)
...
SWEP.IronAnimation = {
	["loop"] = {
		...
		["value_empty"] = "anm_idle_aim_empty"
	},
	["shoot"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, --Sequence or act
		["value"] = "anm_shots", --Number for act, String/Number for sequence
		["value_last"] = "anm_shots_last",
		["value_empty"] = "anm_shots_last"
	}
}
...
SWEP.SprintAnimation = {
	["loop"] = {
		...
		["value_empty"] = "anm_idle_sprint_empty",
		["is_idle"] = false
	}
}
--[[EFFECTS]]--
...
SWEP.VElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/flaymi/anomaly/weapons/attachments/v_models/wpn_addon_sil_9mm.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 0.635, 2.31), angle = Angle(-90, 90, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/flaymi/anomaly/weapons/attachments/w_models/w_addon_sil_9mm.mdl", bone = "wpn_body", rel = "", pos = Vector(0.03, 6, 2.35), angle = Angle(-90, 0, -90), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_9mm" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_pm_sk1", "anomaly_pm_sk_actor" }, order = 5 },
	[2] = { offset = { 0, 0 }, atts = { "anomaly_ammo_9x18_pmm", "anomaly_ammo_9x18_ap" }, order = 6 },
}

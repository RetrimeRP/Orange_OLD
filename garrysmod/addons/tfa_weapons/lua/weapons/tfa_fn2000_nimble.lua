...
SWEP.PrintName				= "FN F2000 «EOTech»"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.FN2000.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.FN2000.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 895 -- This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/fn2000_nimble.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_fn2000_nimble_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(7, -8.2, 0)
SWEP.RunSightsAng = Vector(-15, 50, -14)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-5.55, -6, -0.765)
...
SWEP.VElements = {
	["sight_anomaly_fn2000_lense"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_fn2000_nimb/wpn_fn2000_nimble_lense_hud.mdl", bone = "body", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
	["anomaly_sil_nato"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_fn2000_nimb/wpn_sil_nato.mdl", bone = "wpn_body", rel = "", pos = Vector(0, -0.7, 2.6), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_nato"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_fn2000_nimb/w_wpn_sil_nato.mdl", bone = "wpn_body", rel = "", pos = Vector(0, -0.04, 3.9), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}
...
SWEP.StencilSight = true

SWEP.StencilSight_UseMask = true

SWEP.StencilSight_VElement = "sight_anomaly_fn2000_lense"

SWEP.StencilSight_ReticleType = TFA.Enum.RETICLE_FLAT

SWEP.StencilSight_ReticleMaterial = "models/flaymi/stalker/anomaly/attachments/wpn_addon_scope_eot_sight"

SWEP.StencilSight_ReticleSize = 75

SWEP.StencilSight_FollowRecoil = true

SWEP.StencilSight_MinPercent = 0.7

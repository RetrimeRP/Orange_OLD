...
SWEP.PrintName				= "ВССК «Выхлоп»"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.VSSK.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.VSSK.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 112.5 -- Damage, in standard damage points.
...
SWEP.Primary.StaticRecoilFactor = 3.08 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .0398 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*0.98 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 750/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/vssk.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_vssk_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(8, -6.7, 0)
SWEP.RunSightsAng = Vector(-12.5, 50, -12)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.505, -5, 2.104)
...
SWEP.Attachments = {
	[2] = { offset = { 0, 0 }, atts = { "anomaly_ammo_127x55_ap" }, order = 6 },
}
...
SWEP.ScopeReticule = ("models/flaymi/stalker/anomaly/weapons/vssk/wpn_crosshair_nspu")

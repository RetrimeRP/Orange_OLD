...
SWEP.PrintName				= "СВ-98"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.SV98.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.SV98.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.StaticRecoilFactor = 2.81 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .03--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*0.8  -- Ironsight accuracy, should be the same for shotguns
...
--Range Related
SWEP.Primary.Range = 1200*29.75 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 860/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/sv98.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_sv98_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(6.2, -8.5, 0)
SWEP.RunSightsAng = Vector(-15, 49, -16.5)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.3185, -9, 2.3925)
...
SWEP.Attachments = {
	[6] = { offset = { 0, 0 }, atts = { "anomaly_sv98_sk1" }, order = 5 },
...
SWEP.ScopeReticule = ("models/flaymi/stalker/anomaly/weapons/sv98/wpn_crosshair_sv98")

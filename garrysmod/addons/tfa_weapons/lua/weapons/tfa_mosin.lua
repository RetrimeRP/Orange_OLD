...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.MOSIN.FIRE") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.StaticRecoilFactor = 1.98 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .012 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*1.2 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 845/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/mosin.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_mosin_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(6.3, -10.6, 0.4)
SWEP.RunSightsAng = Vector(-16, 49, -17)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.142, -5, 2.8)
SWEP.IronSightsAng = Vector(0.029, 0, 0)

SWEP.IronSightsPos_MOSINSCOPE = Vector(-4.068, -10, 1.23)
SWEP.IronSightsAng_MOSINSCOPE = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_MOSINSCOPE = 55
...
SWEP.VElements = {
	["scope_anomaly_mosinscope"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_mosin/wpn_mosin_scope_hud.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 0, 0), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.WElements = {
	["scope_anomaly_mosinscope"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_mosin/wpn_mosin_scope.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 0, 0), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.Attachments = {
	[2] = { offset = { 0, 0 }, atts = { "anomaly_ammo_762x54_ap", "anomaly_ammo_762x54_7h14" }, order = 6 },
	[7] = { offset = { 0, 0 }, atts = { "anomaly_mosin" }, order = 2 },
}

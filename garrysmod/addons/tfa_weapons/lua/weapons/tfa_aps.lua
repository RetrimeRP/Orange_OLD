...
SWEP.PrintName				= "АПС"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.APS.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.APS.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.IronAccuracy = .001*6.5 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/aps.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_aps.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.83, -1, 1.54)
SWEP.IronSightsAng = Vector(0.45, -0.01, 0)
...
SWEP.VElements = {
	["anomaly_sil_aps"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sil_aps/sil_aps.mdl", bone = "wpn_silencer", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.WElements = {
	["anomaly_sil_aps"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sil_aps/w_sil_aps.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 1.33, -0.39), angle = Angle(-90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_aps" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_aps_sk1" }, order = 5 },

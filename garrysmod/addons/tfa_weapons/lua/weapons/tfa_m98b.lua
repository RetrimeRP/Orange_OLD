...
SWEP.PrintName				= "Barrett M98B «Bravo»"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.M98B.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 260 -- Damage, in standard damage points.
...
SWEP.Primary.StaticRecoilFactor = 3.14 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .043 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*0.43 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 945/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/m98b.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_m98b_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(7.5, -7, 0.3)
SWEP.RunSightsAng = Vector(-12, 51, -11)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.7551, -5, 2.357)
SWEP.IronSightsAng = Vector(0, 0, -0.1)
...
SWEP.ScopeReticule = ("models/flaymi/stalker/anomaly/weapons/m98b/wpn_crosshair_modern1")

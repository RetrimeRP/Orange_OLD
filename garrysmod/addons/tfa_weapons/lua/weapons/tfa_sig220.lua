...
SWEP.PrintName				= "SIG P220"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.SIG220.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.SIG220.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 27.5 -- Damage, in standard damage points.
...
SWEP.Primary.RPM = 225 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.RangeFalloff = 340/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/sig220.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_sig220_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -2, 3.8)
...
SWEP.IronSightsPos = Vector(-3.7, -1, 2.335)
SWEP.IronSightsAng = Vector(-0.494, 0, 0)
...
SWEP.VElements = {
	["anomaly_sil_45"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sil_45/wpn_addon_sil_45.mdl", bone = "wpn_body", rel = "", pos = Vector(-0.035, -0.18, 0.15), angle = Angle(-90, 90, 0), size = Vector(0.88, 0.88, 0.88), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_45"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sil_45/wpn_addon_sil_45_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 4.84, 0.05), angle = Angle(-90, 0, -90), size = Vector(0.88, 0.88, 0.88), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_45" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_sig220_sk1", "anomaly_sig220_sk4" }, order = 5 },

...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.FNP45.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.FNP45.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 253 -- This is in Rounds Per Minute / RPM
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/fnp45.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_fnp45_w.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.827, -1, 2.217)
...
SWEP.VElements = {
	["anomaly_sil_gemtech"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sil_gemtech/addon_sil_gemtech.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.WElements = {
	["anomaly_sil_gemtech"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sil_gemtech/addon_sil_gemtech_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 1.33, -0.39), angle = Angle(-90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_gemtech" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_fnp45_sk1" }, order = 5 },

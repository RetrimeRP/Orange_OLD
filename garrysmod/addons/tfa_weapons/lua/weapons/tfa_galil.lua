...
SWEP.PrintName				= "Galil AR"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.GALIL.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.GALIL.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
--Firing Cone Related
SWEP.Primary.Spread = .049 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*4.9 -- Ironsight accuracy, should be the same for shotguns
...
--Range Related
SWEP.Primary.Range = 1800*29.75 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 835/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/galil.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/w_rif_galil.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(8.5, -5.5, -0.4)
SWEP.RunSightsAng = Vector(-12, 52, -9)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.28, -1, 2.125)
SWEP.IronSightsAng = Vector(-0.224, 0.05, 0)

SWEP.IronSightsPos_GALILSCOPE = Vector(-3.436, -3, 0.5635)
SWEP.IronSightsAng_GALILSCOPE = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_GALILSCOPE = 60
...
SWEP.VElements = {
	["scope_anomaly_galilscope"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_galil/wpn_galil_scope.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 0, 0), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["anomaly_sil_pbs1"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_galil/sil_pbs.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 0.1, -4.7), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },

}

SWEP.WElements = {
	["scope_anomaly_galilscope"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_galil/wpn_galil_scope_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 0, 0), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["anomaly_sil_pbs1"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_galil/sil_pbs_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 1.65, -3.55), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },

}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_pbs1" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_galil_sk1", "anomaly_galil_sk2" }, order = 5 },
	[7] = { offset = { 0, 0 }, atts = { "anomaly_galilscope" }, order = 2 },

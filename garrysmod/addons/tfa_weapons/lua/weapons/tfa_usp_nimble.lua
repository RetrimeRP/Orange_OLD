...
SWEP.PrintName				= "USP «Марш»"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.IronAccuracy = .001*3.7 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/usp_nimble.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_usp_nimble_w.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.865, -1, 2.52)
...
SWEP.VElements = {
	["anomaly_sil_45"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sil_45/wpn_addon_sil_45.mdl", bone = "wpn_body", rel = "", pos = Vector(-0.02, -0.205, -1), angle = Angle(-90, 90, 0), size = Vector(0.86, 0.86, 0.86), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_45"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sil_45/wpn_addon_sil_45_w.mdl", bone = "wpn_body", rel = "", pos = Vector(-0.012, 4.396, -1.68), angle = Angle(-90, 90, 0), size = Vector(0.86, 0.86, 0.86), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

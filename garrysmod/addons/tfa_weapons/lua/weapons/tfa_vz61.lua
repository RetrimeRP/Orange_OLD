...
SWEP.PrintName				= "Skorpion vz.61"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.VZ61.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.VZ61.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
--Firing Cone Related
SWEP.Primary.Spread = .064 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*6.4 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 370/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
SWEP.MaxPenetrationCounter = 2 --The maximum number of ricochets.  To prevent stack overflows.
--Misc
SWEP.IronRecoilMultiplier = 0.27 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/vz61.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_vz61_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(6.8, -8.85, 0.95)
SWEP.RunSightsAng = Vector(-17, 50, -14)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.861, -1, 2.249)
SWEP.IronSightsAng = Vector(-0.5, 0.005, 0)
...
SWEP.VElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sill_9mm/wpn_addon_sil_9mm.mdl", bone = "wpn_body", rel = "", pos = Vector(-0.01, -0.805, -4.7), angle = Angle(-90, 90, 0), size = Vector(1.025, 1.025, 1.025), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sill_9mm/w_addon_sil_9mm.mdl", bone = "wpn_body", rel = "", pos = Vector(-0.01, 5.1, -4.7), angle = Angle(-90, 90, 0), size = Vector(1.025, 1.025, 1.025), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_9mm" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_vz61_sk1", "anomaly_vz61_sk2", "anomaly_vz61_sk3" }, order = 5 },

...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.HPSA.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.HPSA.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 265 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.RangeFalloff = 360/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/hpsa.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_hpsa_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -1, 3.6)
...
SWEP.IronSightsPos = Vector(-3.755, -1, 1.9595)
...
SWEP.VElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sill_9mm/wpn_addon_sil_9mm.mdl", bone = "wpn_body", rel = "", pos = Vector(-0.035, 0.47, 0.5), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sill_9mm/w_addon_sil_9mm.mdl", bone = "wpn_body", rel = "", pos = Vector(-0.035, 5.48, -0.5), angle = Angle(-90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_9mm" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_hpsa_sk1" }, order = 5 },

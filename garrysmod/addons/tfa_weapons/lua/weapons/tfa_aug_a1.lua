...
SWEP.PrintName				= "Steyr AUG A1"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.AUG_A1.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.AUG_A1.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/wpn_aug_a1.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/w_aug_a1.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(6, -8.25, 0.7)
...
SWEP.IronSightsPos = Vector(-4.402, -4, 1.71)
...
SWEP.VElements = {
	["anomaly_sil_nato"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_scar_sight/wpn_sil_nato.mdl", bone = "wpn_body", rel = "", pos = Vector(0, -0.3, -2.5), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_nato"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_scar_sight/w_wpn_sil_nato.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 1.69, -0.1), angle = Angle(-90, 90, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_nato" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_aug_a1_sk1", "anomaly_aug_a1_sk2", "anomaly_aug_a1_sk3", "anomaly_aug_a1_sk4", "anomaly_aug_a1_sk5" }, order = 5 },
...
SWEP.ScopeReticule = ("models/flaymi/stalker/anomaly/weapons/aug_a1/wpn_crosshair_aug_a1")

SWEP.RTMaterialOverride = -1 --the number of the texture, which you subtract from GetAttachment

SWEP.RTOpaque = false

SWEP.Secondary.ScopeZoom = 1 --IMPORTANT BIT
SWEP.RTScopeAttachment = 0
SWEP.RTScopeFOV = 10
SWEP.ScopeAngleTransforms = {}
SWEP.ScopeOverlayTransformMultiplier = 10

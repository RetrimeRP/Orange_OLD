...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.CZ75.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.CZ75.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 258 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.IronAccuracy = .001*4 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 375/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/cz75.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_cz75_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(-0.5, -3, 4)
...
SWEP.IronSightsPos = Vector(-4.3, -1, 2.218)
SWEP.IronSightsAng = Vector(1, 0.4, 0)
...
SWEP.VElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sill_9mm/wpn_addon_sil_9mm.mdl", bone = "wpn_body", rel = "", pos = Vector(0.02, 0.46, 0.85), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sill_9mm/w_addon_sil_9mm.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 5.57, 0.1), angle = Angle(-90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

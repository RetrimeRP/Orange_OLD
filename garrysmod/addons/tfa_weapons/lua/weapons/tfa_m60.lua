...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.M60.FIRE") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.IronAccuracy = .001*2.5 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/m60.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_m60_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(7, -7.5, 0.5)
SWEP.RunSightsAng = Vector(-15, 51, -11)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-5.655, 0, 0.055)
SWEP.IronSightsAng = Vector(2.01, 0.5, 0)

...
SWEP.PrintName				= "MP-443 «Грач»"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.GRACH.FIRE") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.RPM = 293 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.IronAccuracy = .001*3.8 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/grach.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_grach_w.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.83, -1, 2.19)

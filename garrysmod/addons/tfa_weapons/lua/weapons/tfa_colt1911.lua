...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.COLT1911.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.COLT1911.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.IronAccuracy = .001*6 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 270/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/colt1911.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_colt1911_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -1, 3.5)
...
SWEP.IronSightsPos = Vector(-3.74, -1, 2.058)
...
SWEP.VElements = {
	["anomaly_sil_45"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sil_45/wpn_addon_sil_45.mdl", bone = "wpn_silencer", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.WElements = {
	["anomaly_sil_45"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sil_45/wpn_addon_sil_45_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 0, 0), angle = Angle(-90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_45" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_colt1911_sk1", "anomaly_colt1911_sk2", "anomaly_colt1911_sk3", "anomaly_colt1911_sk4", "anomaly_colt1911_sk5" , "anomaly_colt1911_sk6", "anomaly_colt1911_sk7" }, order = 5 },

...
SWEP.Author				= "Vito :D" --Author Tooltip
...
SWEP.PrintName				= "SR-25"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.SR25.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.SR25.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
SWEP.Primary.GLSound = Sound("TFA_ANOMALY.SR25.ShootGL")
...
SWEP.Primary.StaticRecoilFactor = 1.58 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .023--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*2.3  -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/sr25.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_sr25_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(7, -6.2, 0)
SWEP.RunSightsAng = Vector(-19, 48.5, -20)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.78, -7.5, 1.512)
...
SWEP.VElements = {
	["anomaly_sil_sr25"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sr25/wpn_sr25_sil_hud.mdl", bone = "wpn_body", rel = "", pos = Vector(0.05, -1.34, -10.9), angle = Angle(-90, 90, 0), size = Vector(0.92, 0.92, 0.92), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["gl"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sr25/wpn_sr25_gl_hud.mdl", bone = "wpn_body", rel = "", pos = Vector(0.13, -2.8, -0.15), angle = Angle(-90, 90, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.WElements = {
	["anomaly_sil_sr25"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sr25/wpn_sr25_sil_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 0, 0), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["gl"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sr25/wpn_sr25_gl_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0.13, -2.8, -0.15), angle = Angle(-90, 90, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_sr25" }, order = 1 },
...
SWEP.ScopeReticule = ("models/flaymi/stalker/anomaly/weapons/l96/wpn_crosshair_mark4")

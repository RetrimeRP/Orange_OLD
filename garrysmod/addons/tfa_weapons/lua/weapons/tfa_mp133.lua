...
SWEP.PrintName				= "MP-133"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.MP133.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.MP133.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.StaticRecoilFactor = 6.4/3 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
...
--Misc
SWEP.IronRecoilMultiplier = 0.584*1.2 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/mp133.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_mp133_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(6.5, -9.5, 1.6)
SWEP.RunSightsAng = Vector(-14, 49, -10)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.72, 0, 3.3)
SWEP.IronSightsAng = Vector(0.268, 0, 0)

...
SWEP.PrintName				= "Обрез ТОЗ-66"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.BM16.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 38.5/9*3 -- Damage, in standard damage points.
...
SWEP.Primary.StaticRecoilFactor = 9.92/3 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
...
--Range Related
SWEP.Primary.Range = 200*29.75 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 300/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
SWEP.MaxPenetrationCounter = 2 --The maximum number of ricochets.  To prevent stack overflows.
--Misc
SWEP.IronRecoilMultiplier = 0.913 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/bm16.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_bm16_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(6.5, -7.5, 0.55)
...
SWEP.IronSightsPos = Vector(-2.97, -2, 2.495)
...
SWEP.Animations = {
	["draw"] = {
	 	...
	 	["value"] = "anm_show",
	 	["value_last"] = "anm_show_last",
		["value_empty"] = "anm_show_empty",
		["enabled"] = true
	},
	["idle"] = {
	 	["type"] = TFA.Enum.ANIMATION_SEQ,
	 	["value"] = "anm_idle",
	 	["value_last"] = "anm_idle_last",
	 	["value_empty"] = "anm_idle_empty",
		["enabled"] = true
	},
	["holster"] = {
	 	["type"] = TFA.Enum.ANIMATION_SEQ,
	 	["value"] = "anm_hide",
	 	["value_last"] = "anm_hide_last",
	 	["value_empty"] = "anm_hide_empty",
	 	["enabled"] = true
	},
...
SWEP.SprintAnimation = {
	["loop"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, --Sequence or act
		["value"] = "anm_idle_sprint",
	 	["value_last"] = "anm_idle_sprint_last",
...
SWEP.Attachments = {
	[6] = { offset = { 0, 0 }, atts = { "anomaly_bm16_sk1" }, order = 5 },

...
SWEP.PrintName				= "Karabiner 43"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.G43.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 40.5 -- Damage, in standard damage points.
...
SWEP.Primary.StaticRecoilFactor = 2.3 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .014 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*1.4 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 740/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/g43.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_g43_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(7.5, -7.5, 0.4)
SWEP.RunSightsAng = Vector(-15, 51.5, -14)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.6123, -6.5, 1.583)
SWEP.IronSightsAng = Vector(0, 0, -0.2)
...
SWEP.ScopeReticule = ("models/flaymi/stalker/anomaly/weapons/g43/wpn_crosshair_g43")

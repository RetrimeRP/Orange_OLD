...
SWEP.PrintName				= "L85A1"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.L85.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.L85.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
--Firing Cone Related
SWEP.Primary.Spread = .0215 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*2.15 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/l85.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/wpn_l85_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(5.5, -5, 0.6)
SWEP.RunSightsAng = Vector(-13, 47, -11)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-3.9264, 2, 1.985)
...
--SWEP.VElements = {
--	["anomaly_sil_nato"] = { type = "Model", model = "models/flaymi/anomaly/weapons/attachments/v_models/wpn_sil_nato.mdl", bone = "wpn_body", rel = "", pos = Vector(0.11, -1.09, 1.2), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
--}
--
--SWEP.WElements = {
--	["anomaly_sil_nato"] = { type = "Model", model = "models/flaymi/anomaly/weapons/attachments/w_models/w_wpn_sil_nato.mdl", bone = "wpn_body", rel = "", pos = Vector(0.1, 1.82, 1.5), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
--}

SWEP.Attachments = {
	--[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_nato" }, order = 1 },
--	[6] = { offset = { 0, 0 }, atts = { "anomaly_l85_sk1", "anomaly_l85_sk2", "anomaly_l85_sk3" }, order = 5 },

...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.TRG.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.TRG.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 67.5 -- Damage, in standard damage points.
...
SWEP.Primary.RPM = 23 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.StaticRecoilFactor = 2.72 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .039--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*0.39  -- Ironsight accuracy, should be the same for shotguns
...
--Range Related
SWEP.Primary.Range = 1500*29.75 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 841/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/trg.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_trg_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(7.2, -6.5, -0.5)
SWEP.RunSightsAng = Vector(-13.5, 50.6, -13.5)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.4598, -10, 0.603)
...
SWEP.VElements = {
	["anomaly_sil_57"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_trg_sil/wpn_trg_sil_hud.mdl", bone = "wpn_silencer", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.WElements = {
	["anomaly_sil_57"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_trg_sil/wpn_trg_sil_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 1.86, -0.8), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}
...
SWEP.ScopeReticule = ("models/flaymi/stalker/anomaly/weapons/trg/wpn_crosshair_findot")

...
SWEP.PrintName				= "FNX-45 Tactical"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.FNX45.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.FNX45.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
--Firing Cone Related
SWEP.Primary.Spread = .043 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*4.3 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/fnx45.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_fnx45_w.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.808, -1, 2.16)
...
SWEP.VElements = {
	["sight_anomaly_fnx45_lense"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_fnx45_lense/wpn_fnx45_lense_hud.mdl", bone = "body", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true, bonemerge = true },
}
...
SWEP.Attachments = {
	[6] = { offset = { 0, 0 }, atts = { "anomaly_fnx45_sk1", "anomaly_fnx45_sk2" }, order = 5 },
...
SWEP.StencilSight_VElement = "sight_anomaly_fnx45_lense"

SWEP.StencilSight_ReticleType = TFA.Enum.RETICLE_FLAT

SWEP.StencilSight_ReticleMaterial = "models/flaymi/stalker/anomaly/attachments/wpn_addon_scope_c-more_crosshair_dot"

...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.MOSSBERG590.FIRE") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.StaticRecoilFactor = 7.22/3 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .051 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--Misc
SWEP.IronRecoilMultiplier = 0.663*1.2 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/mossberg590.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_mossberg590_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(5.8, -7.6, 1.2)
...
SWEP.IronSightsPos = Vector(-3.01, 0, 3.1)
SWEP.IronSightsAng = Vector(-0.061, 0.01, 0)

...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/pkm.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_pkm_w.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.481, 0, 1.6)
SWEP.IronSightsAng = Vector(-0.285, 0, 0)

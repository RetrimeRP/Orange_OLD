...
SWEP.PrintName				= "Beretta 92F"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.BERETTA.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.BERETTA.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.IronAccuracy = .001*4.8 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 362/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/beretta92fs.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_beretta92fs.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.85, -1, 2.158)
...
SWEP.VElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sill_9mm/wpn_addon_sil_9mm.mdl", bone = "wpn_silencer", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.WElements = {
	["anomaly_sil_9mm"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sill_9mm/w_addon_sil_9mm.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 1.33, -0.39), angle = Angle(-90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = true, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_9mm" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_beretta_sk1", "anomaly_beretta_sk2", "anomaly_beretta_sk3" }, order = 5 },

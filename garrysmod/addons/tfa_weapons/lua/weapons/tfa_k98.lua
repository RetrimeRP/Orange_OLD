...
SWEP.PrintName				= "Karabiner 98 Kurz"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.K98.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.K98.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 57.5 -- Damage, in standard damage points.
...
SWEP.Primary.StaticRecoilFactor = 2.35 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .013 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*1.3 -- Ironsight accuracy, should be the same for shotguns
...
--Range Related
SWEP.Primary.Range = 1100*29.75 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
SWEP.Primary.RangeFalloff = 760/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/kar98k.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_kar98k_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(8, -7.1, 0.15)
SWEP.RunSightsAng = Vector(-14, 52, -13)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.07, 0, 3)
SWEP.IronSightsAng = Vector(-0.25, -0.02, 0)

SWEP.IronSightsPos_ZF4 = Vector(-3.9912, -5.5, 2.053)
SWEP.IronSightsAng_ZF4 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_ZF4 = 60
...
SWEP.VElements = {
	["anomaly_sil_nato"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_kar98/wpn_k98_sil.mdl", bone = "wpn_body", rel = "", pos = Vector(0, -0.3, -2.5), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["scope_anomaly_zf4"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_kar98/wpn_k98_stock.mdl", bone = "body", rel = "", pos = Vector(0.15, 0.25, 2), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },	
}

SWEP.WElements = {
	["anomaly_sil_nato"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_kar98/wpn_k98_sil_w.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 1.69, -0.1), angle = Angle(-90, 90, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
	["scope_anomaly_zf4"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_kar98/wpn_k98_stock_w.mdl", bone = "body", rel = "", pos = Vector(0.15, 0.25, 2), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_nato" }, order = 1 },
	[7] = { offset = { 0, 0 }, atts = { "anomaly_scope_zf4" }, order = 2 },
	[2] = { offset = { 0, 0 }, atts = { "anomaly_ammo_792x33_ap" }, order = 6 },
}

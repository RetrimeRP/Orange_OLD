...
SWEP.Category				= "Retrime [Гранатомет]" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
SWEP.PrintName				= "РГ-6"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Sound			= "TFA_ANOMALY.RG6.FIRE"
...
SWEP.IronSightsPos = Vector(-4.5, 3, -3)
SWEP.IronSightsAng = Vector(10, 0, 0)

SWEP.RunSightsPos = Vector(6.8, -7.2, 0.5)
SWEP.RunSightsAng = Vector(-11, 50, -10.5)
...
SWEP.ViewModel			= "models/orange/weapons/v_models/rg6.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_rg6_w.mdl" -- Weapon world model path
...
SWEP.ProjectileEntity = "anomaly_rg6_rocket" --Entity to shoot
SWEP.ProjectileVelocity = 295 * 16 / 12 * 39.3701  --Entity to shoot's velocity
SWEP.ProjectileModel = "models/orange/ammo/wpn_vog.mdl" --Entity to shoot

...
SWEP.PrintName				= "Armsel Protecta"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.PROTECTA.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.PROTECTA.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 39/9*3 -- Damage, in standard damage points.
...
SWEP.Primary.RPM = 155 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.StaticRecoilFactor = 6.46/3 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .052 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.Primary.RangeFalloff = 320/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
SWEP.MaxPenetrationCounter = 2 --The maximum number of ricochets.  To prevent stack overflows.
--Misc
SWEP.IronRecoilMultiplier = 0.554*1.2	 --Multiply recoil by this factor when we're in ironsights.  This is proportional, not inversely.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/protecta.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_protecta_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(7.5, -6.45, 0)
SWEP.RunSightsAng = Vector(-15, 51, -15)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.298, -3, 0.145)
SWEP.IronSightsAng = Vector(2.11, 0, 0)
...
SWEP.LuaShellModel = "models/tfa/shotgunshell.mdl"
--Tracer Stuff
...
SWEP.Attachments = {
	[6] = { offset = { 0, 0 }, atts = { "anomaly_protecta_sk1", "anomaly_protecta_sk2" }, order = 5 },

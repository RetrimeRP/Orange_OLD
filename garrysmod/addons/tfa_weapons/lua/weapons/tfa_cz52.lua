...
SWEP.PrintName				= "CZ 52"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.CZ52.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.CZ52.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM = 305 -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.IronAccuracy = .001*1.5 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 420/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/cz52.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_cz52_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(0, -2, 3.5)
...
SWEP.IronSightsPos = Vector(-2.807, -3, 2.495)
SWEP.IronSightsAng = Vector(0.5, 0.4, 0)
...
SWEP.Attachments = {
	[2] = { offset = { 0, 0 }, atts = { "anomaly_ammo_762x25_ps" }, order = 6 },
}

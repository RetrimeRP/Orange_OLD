...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.DESERT_EAGLE.FIRE") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.StaticRecoilFactor = 4.0/2 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Primary.Spread = .063 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .001*6.3 -- Ironsight accuracy, should be the same for shotguns
...
SWEP.Primary.RangeFalloff = 450/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/desert_eagle.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_desert_eagle_w.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.75, -1, 1.853)
...
SWEP.Attachments = {
	[6] = { offset = { 0, 0 }, atts = { "anomaly_desert_eagle_sk1", "anomaly_desert_eagle_sk2" }, order = 5 },
}

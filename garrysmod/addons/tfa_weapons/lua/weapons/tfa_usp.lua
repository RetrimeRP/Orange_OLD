...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.USP45.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.USP45.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RangeFalloff = 260/SWEP.Primary.Range -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/usp45.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_usp45_w.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-3.878, -1, 2.325)
...
SWEP.VElements = {
	["anomaly_sil_45"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_sil_45/wpn_addon_sil_45.mdl", bone = "wpn_body", rel = "", pos = Vector(-0.01, -0.205, 0.2), angle = Angle(-90, 90, 0), size = Vector(0.86, 0.86, 0.86), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["anomaly_sil_45"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_sil_45/wpn_addon_sil_45_w.mdl", bone = "wpn_body", rel = "", pos = Vector(-0.012, 4.396, -0.1), angle = Angle(-90, 90, 0), size = Vector(0.86, 0.86, 0.86), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "anomaly_sil_45" }, order = 1 },
	[6] = { offset = { 0, 0 }, atts = { "anomaly_usp_sk1" }, order = 5 },

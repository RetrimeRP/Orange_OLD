...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("TFA_ANOMALY.VINTOREZ.FIRE") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("TFA_ANOMALY.VINTOREZ.FIRE_SILENCED") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.KickHorizontal = 0.46 -- This is the maximum sideways recoil (no real term)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/orange/weapons/v_models/vintorez.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/orange/weapons/w_models/wpn_vintorez_w.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(8, -9, 0)
SWEP.RunSightsAng = Vector(-13, 53.5, -13)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightsPos = Vector(-4.095, -3, 2.595)
SWEP.IronSightsAng = Vector(0, 0.04, 0)

SWEP.IronSightsPos_Kobra = Vector(-4.095, -3, 1.02)
SWEP.IronSightsAng_Kobra = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_Kobra = 70

SWEP.IronSightsPos_PSO1M21 = Vector(-3.785, -6, 1.2175)
SWEP.IronSightsAng_PSO1M21 = Vector(0, 0, 0)
SWEP.Secondary.IronFOV_PSO1M21 = 60

SWEP.IronSightsPos_1P29 = Vector(-4.1628, -7, 1.055)
...
SWEP.VElements = {
	["sight_anomaly_kobra"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_9a91/wpn_9a91_kobra_hud.mdl", bone = "wpn_body", rel = "", pos = Vector(0.0233, -0.1, 1.3), angle = Angle(-90, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["sight_anomaly_kobra_lense"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_9a91/wpn_9a91_kobra_lense_hud.mdl", bone = "wpn_body", rel = "", pos = Vector(0.0233, -0.1, 1.3), angle = Angle(-90, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["scope_anomaly_1p29"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_9a91/wpn_9a91_1p29_hud.mdl", bone = "wpn_body", rel = "", pos = Vector(0.0233, -0.1, 0.25), angle = Angle(-90, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["scope_anomaly_pso1m21"] = { type = "Model", model = "models/orange/weapons/attachments/v_models/atta_9a91/wpn_9a91_pso1m21_hud.mdl", bone = "wpn_body", rel = "", pos = Vector(0.0233, -0.1, 0.25), angle = Angle(-90, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
}

SWEP.WElements = {
	["sight_anomaly_kobra"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_9a91/wpn_9a91_kobra.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 6, 2), angle = Angle(-90, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["scope_anomaly_1p29"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_9a91/wpn_9a91_1p29.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 6, 0.5), angle = Angle(-90, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
	["scope_anomaly_pso1m21"] = { type = "Model", model = "models/orange/weapons/attachments/w_models/atta_9a91/wpn_9a91_pso1m21.mdl", bone = "wpn_body", rel = "", pos = Vector(0, 6, 0.5), angle = Angle(-90, 90, 0), size = Vector(0.9, 0.9, 0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false },
}

SWEP.Attachments = {
	[6] = { offset = { 0, 0 }, atts = { "anomaly_vintorez_sk1" }, order = 5 },

...
ATTACHMENT.Name = "Глушитель 5,7x28мм"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { [[
Прибор бесшумной стрельбы для пистолета-пулемёта FN P90.

Глушение звука: высокое
]] }
ATTACHMENT.Icon = "entities/anomaly/addons/addon_sil_57.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "Глушитель 5,7x28мм"

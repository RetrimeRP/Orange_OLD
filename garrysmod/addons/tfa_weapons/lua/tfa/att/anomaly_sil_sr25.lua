...
ATTACHMENT.Name = "Глушитель SR-25"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { [[
Прибор для беззвучной и беспламенной стрельбы из самозарядной снайперской винтовки SR-25.

Глушение звука: высокое
]] }
ATTACHMENT.Icon = "entities/anomaly/addons/addon_sil_sr25.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "Глушитель SR-25"

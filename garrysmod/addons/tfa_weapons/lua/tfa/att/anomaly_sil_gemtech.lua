...
ATTACHMENT.Name = "Глушитель GemTech"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { [[
Прибор бесшумной стрельбы для пистолетов Glock и FN FNP.

Глушение звука: высокое
]] }
ATTACHMENT.Icon = "entities/anomaly/addons/addon_sil_gemtech.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "Глушитель GemTech"

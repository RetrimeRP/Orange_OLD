...
SWEP.Author				= "Vito" --Author Tooltip
SWEP.Type 				= "9mm Semi-Auto Handgun"
SWEP.Description 		= ""
SWEP.Contact			= "" --Contact Info Tooltip
SWEP.Purpose			= "Civil Protection Standard Issue 9mm Handgun" --Purpose Tooltip
...
SWEP.PrintName			= "H&K USP Match CMB"		-- Weapon name (Shown on HUD)

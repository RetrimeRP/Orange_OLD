...
SWEP.Purpose				= "Standard Issue 12 Gauge Shotgun" --Purpose Tooltip
...
--Recoil Related
SWEP.Secondary.KickUp = 2 -- This is the maximum upwards recoil (rise)
SWEP.Secondary.KickDown = 0.3 -- This is the maximum downwards recoil (skeet)
SWEP.Secondary.KickHorizontal = 0.3 -- This is the maximum sideways recoil (no real term)
SWEP.Secondary.StaticRecoilFactor = 0.7 --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.  This is also affected by a convar that defaults to 0.5.
--Firing Cone Related
SWEP.Secondary.Spread = .056 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
--Unless you can do this manually, autodetect it.  If you decide to manually do these, uncomment this block and remove this line.
...
SWEP.Secondary.Sound			= Sound("TFA_MMOD.Shotgun.2")

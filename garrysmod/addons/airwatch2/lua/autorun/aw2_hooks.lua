...
hook.Add("Initialize", "aw2_setup", function()
	CreateConVar("aw2_chopper_health", 1000000, {FCVAR_REPLICATED, FCVAR_ARCHIVE}, "Determines the amount of HP the hunter chopper has when spawned, only applies to newly spawned instances")
	...
	CreateConVar("aw2_gunship_health", 1000000, {FCVAR_REPLICATED, FCVAR_ARCHIVE}, "Determines the amount of HP the gunship has when spawned, only applies to newly spawned instances")
	...
	CreateConVar("aw2_hk_health", 1000000, {FCVAR_REPLICATED, FCVAR_ARCHIVE}, "Determines the amount of HP the gunship has when spawned, only applies to newly spawned instances")

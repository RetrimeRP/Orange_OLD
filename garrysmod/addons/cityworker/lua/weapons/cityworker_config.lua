SWEP.PrintName              = "НЕ ТРОГАЙ СУКА"
SWEP.Author                 = "@maikdagovskiy || DISCORD"
SWEP.Purpose                = "Рабочий"
SWEP.Instructions           = "КОМУ СКАЗАЛ НЕ ТРОГАТЬ."

SWEP.Category               = "!gsr raznorabochiy"
SWEP.Spawnable              = true
SWEP.AdminOnly              = true
